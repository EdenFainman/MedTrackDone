...
public class ScanCodeActivitySearch extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result result) {
        ...
        // on code scanned. set qr/bar code result on AllProductsActivity search bar
        AllProductsActivity.resultsearcheview.setText(result.getText());

        //go back to AllProductsActivity
        onBackPressed();
    }
